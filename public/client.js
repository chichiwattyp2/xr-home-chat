// EDIT THIS to your deployed Vercel domain (no trailing slash), e.g.:
// const API_BASE = "https://your-app.vercel.app";
const API_BASE = ""; // if blank, it will use same-origin (useful for local vercel dev)
...
async function startVoice() {
  const session = await fetch(api('/api/realtime-token')).then(r => r.json());
